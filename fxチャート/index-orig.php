...
<html>
    ...
    <body  id="body">
      ...
      <br />
      <a href="language.php"><img id="languageIMG1" src="png/globalLNG2.png"></a>
      <div id="whole">
        <div id="sub" >
          <br/><br /><br/><br />
          <p><a href="select.php?hl=orig">past data</a></p>
          <p><a href="news.php?hl=en&from_hl=orig">News(English)</a></p>
          <p><a href="news.php?hl=ja&from_hl=orig">ニュース(日本語)</a></p>
          <p><a href="news.php?hl=zh&from_hl=orig">最新消息(中文)</a></p>
          <p><a href="language.php">Change Language</a></p>
        </div>

      <div class="main">
        <a href="language.php"><img id="languageIMG2" src="png/globalLNG.png"></a>
        <br />
    ...
    <div class="link" style="text-align: right"><a href="news.php?hl=en&from_hl=orig">details of News</a> 　</div>
    <br /><br />
    ...
    <table>
      ...
      <?php
          ...
          try {	
                  ...
                  print '<div class="link" style="text-align: right"><a href="select.php?hl=orig"> past data</a> 　</div><br /><br /></div><br/><br/>';
        ...
        try {	
                ...
                foreach( $res as $value ) {	
                    ...
                    if (isset($_COOKIE['goodbutton' .$value["id"]])) {
                      ...
                      print '<form method="post" action="good.php?hl=orig" style="display: inline" >';
